...
type BrowserProxyOptions = browser.BrowserProxyOptions
type BrowserRequest = browser.BrowserRequest
type BrowserResult = browser.BrowserResult
type BrowserSessionOptions = browser.BrowserSessionOptions
type BrowserSessionStats = browser.BrowserSessionStats
type BrowserSession = browser.BrowserSession
...
var (
	...
	NewBrowserSession                 = browser.NewBrowserSession
