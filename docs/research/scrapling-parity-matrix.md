...
| CLI extract and shell | CLI shell and extract commands | Install guidance, static extract, advanced output/browser command seams, shell get/post/put/delete page shortcuts, help output, pages history expressions, view artifacts, and curl helpers complete; browser shortcut boundaries planned before deeper shell/REPL gaps | partial |
...
- `Shell browser shortcut boundary`
