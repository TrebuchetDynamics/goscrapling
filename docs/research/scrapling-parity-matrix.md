...
| CLI extract and shell | CLI shell and extract commands | Install guidance, static extract, advanced output/browser command seams, shell get/post/put/delete page shortcuts, help output, pages history expressions, and curl helpers complete; view(page) boundary planned before deeper shell/REPL gaps | partial |
