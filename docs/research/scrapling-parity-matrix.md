...
| CLI extract and shell | CLI shell and extract commands | Install guidance, static extract, advanced output/browser command seams, shell get/post/put/delete page shortcuts, help output, and curl helpers complete; pages history expressions planned before deeper shell/REPL gaps | partial |
...
- `Shell pages history expression shortcuts`
