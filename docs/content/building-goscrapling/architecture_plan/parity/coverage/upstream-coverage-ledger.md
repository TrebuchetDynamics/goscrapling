...
| `scrapling/core/shell.py`, `scrapling/core/_shell_signatures.py`, `scrapling/core/utils/_shell.py` | CLI shell and extract commands | `cmd/goscrapling`, `internal/cli` scripted shell evaluator, get/post/put/delete page shortcuts, help/namespace listing, curl helper parsing/execution, planned pages history expressions, markdown/AI-targeted extract output cleanup, and non-mutating install guidance | Phase 5 | partial |
