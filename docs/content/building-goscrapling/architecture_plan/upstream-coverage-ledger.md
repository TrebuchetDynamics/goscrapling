...
| `docs/api-reference/fetchers.md`, `docs/fetching/**` | Fetchers and browser fetching | `fetchers`, explicit static identity boundaries, Go-native concurrent static fetching, `engines/browser`, and root facade aliases | Phase 1, Phase 3 | partial |
