...
| `scrapling/engines/_browsers/**` | Browser fetching | `engines/browser.BrowserFetcher`, `ChromedpBrowserEngine`, `BrowserSession` session/page pool lifecycle, explicit browser context/resource options, wait/action/capture controls, and root facade aliases | Phase 3 | partial |
