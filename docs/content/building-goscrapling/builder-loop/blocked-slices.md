...
| phase-1-response-fetcher / static-fetcher | Static request options: params, forms, JSON, auth, verify, and cookies | Response cookies, history, meta, and captured XHR fields | Static Fetcher methods and Response extended metadata are stable. | - |
