...
```sh
git add docs/superpowers/specs/validation/2026-05-20-cross-layer-e2e-design.md docs/superpowers/plans/validation/2026-05-20-cross-layer-e2e.md docs/content/building-goscrapling/architecture_plan/progress.json docs/content/building-goscrapling/builder-loop/surfaces/queue/agent-queue.md docs/content/building-goscrapling/builder-loop/surfaces/queue/next-slices.md cmd/goscrapling/cross_layer_e2e_test.go
