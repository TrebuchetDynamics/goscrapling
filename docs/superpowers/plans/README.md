...
- `architecture-deepening/` owns no-behavior-change refactor plans for existing runtime seams. It exposes characterization-test-first deepening steps and must never change public APIs or product behavior silently.
