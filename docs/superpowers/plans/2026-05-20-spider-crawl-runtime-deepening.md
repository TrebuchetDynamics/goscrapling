...
- Created: `docs/superpowers/plans/2026-05-20-spider-crawl-runtime-deepening.md`
...
```sh
git add spiders/crawler.go spiders/crawl_runtime.go docs/superpowers/plans/2026-05-20-spider-crawl-runtime-deepening.md
